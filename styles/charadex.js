...
let optionSorter = (options) => {
    ...
    let scrubbedSheetId = sheetID ? sheetID.includes('/d/') ? sheetID.split('/d/')[1].split('/edit')[0] : sheetID : "https://docs.google.com/spreadsheets/d/1wmGjPj7PYhIQNZkizfd-98N4vgPZM_3IeLTufvWnHEY/edit?usp=sharing";
